namespace VideoSyncPrototype.Phone.Core.Localization;
...
internal static class L
{
    ...
    internal static class Phone
    {
        ...
        public static readonly LocString EnableBody = new("phone.enableBody", "Voice calls with other VideoSyncPrototype.Phone users");
    ...
    internal static class Settings
    {
        ...
        public static readonly LocString AboutAetherphone = new("settings.aboutAetherphone", "About VideoSyncPrototype.Phone");
        ...
        public static readonly LocString PrivacyHint = new("settings.privacyHint", "VideoSyncPrototype.Phone is made by one solo developer. Sharing anonymous usage, which apps you open and for how long plus your region, helps me see what to build next. It never includes your character name, your messages, or any personal data.");
        public static readonly LocString ConsentTitle = new("settings.consentTitle", "Analytics & Consent");
        public static readonly LocString ConsentMessage = new("settings.consentMessage", "VideoSyncPrototype.Phone is made by one solo developer. To keep making it better for everyone, it really helps to know which apps people use and where to focus next.\n\nWith your OK, the app shares anonymous usage only: which apps you open and for how long, plus your region. It never includes your character name, your messages, or any personal data.\n\nYou can change this anytime in Settings, under Privacy. Thank you for helping shape VideoSyncPrototype.Phone.");
    ...
    internal static class Changelog
    {
        ...
        public static readonly LocString[] Release0850 =
        {
            ...
            new("changelog.r0850.26", "The server info bar entry now shows VideoSyncPrototype.Phone with your unread notification count and always stays in English"),
        ...
        {
            new("changelog.r0100.0", "Introduced VideoSyncPrototype.Phone, an in-game smartphone in a single window"),
    ...
    {
        public static readonly LocString CommandHelp =new("plugin.commandHelp", "Toggle the VideoSyncPrototype.Phone. /phone market [item] opens the market board, /phone about opens credits & links, /phone reset recenters the phone, /phone test sends a sample notification.");
    ...
    internal static class Onboarding
    {
        ...
        public static readonly LocString WelcomeTitle = new("onboarding.welcomeTitle", "Welcome to VideoSyncPrototype.Phone");
        ...
        public static readonly LocString FeedbackBody = new("onboarding.feedbackBody", "This plugin is nowhere near a full release yet. I would love your opinions, feature ideas, and criticism. Reach me on GitHub: the links are in Settings, About VideoSyncPrototype.Phone.");
        ...
        public static readonly LocString LockBody = new("onboarding.lockBody", "Tap this to lock or unlock the phone's position on your screen, so it stays put while you play. That's the tour: enjoy your VideoSyncPrototype.Phone.");
        ...
        public static readonly LocString ChirperBody = new("onboarding.chirperBody", "Welcome to Chirper! A little social feed built just for the VideoSyncPrototype.Phone community, short posts and timelines with other players.");
        ...
        public static readonly LocString AethergramBody = new("onboarding.aethergramBody", "Welcome to Aethergram! A photo-sharing app made for the VideoSyncPrototype.Phone community, a lot like the real thing.");
        ...
        public static readonly LocString PhoneBody = new("onboarding.phoneBody", "Call your friends directly in-game and talk over voice chat. The other person needs the VideoSyncPrototype.Phone plugin too, and you both need to be signed in to Aethernet from Settings.");
