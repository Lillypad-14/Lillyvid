...
namespace VideoSyncPrototype.Phone.Apps.Games.BubbleShooter;
...
internal sealed class BubbleRenderer
{
    private static readonly Vector4[] BubbleColors =
    {
        ...
        new(0.95f, 0.78f, 0.34f, 1f), new(0.72f, 0.50f, 0.96f, 1f),
    };
    ...
    public void Draw(BubbleBoard board, Rect field, float scale, Vector2 aimDirection, PhoneTheme theme)
    {
        ...
        drawList.AddLine(new Vector2(field.Min.X, dangerY), new Vector2(field.Max.X, dangerY),
            ImGui.GetColorU32(new Vector4(0.95f, 0.35f, 0.35f, 0.35f)), 1.4f * scale);
    ...
    private void DrawAim(ImDrawListPtr drawList, BubbleBoard board, Rect field, float factor, float radius,
        Vector2 direction)
    {
