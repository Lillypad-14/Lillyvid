...
using VideoSyncPrototype.Phone.Apps.Games.Breakout;
using VideoSyncPrototype.Phone.Apps.Games.BubbleShooter;
using VideoSyncPrototype.Phone.Apps.Games.Chocobo;
using VideoSyncPrototype.Phone.Apps.Games.Flap;
using VideoSyncPrototype.Phone.Apps.Games.Flow;
using VideoSyncPrototype.Phone.Apps.Games.Framework;
using VideoSyncPrototype.Phone.Apps.Games.GemSwap;
using VideoSyncPrototype.Phone.Apps.Games.Nonogram;
using VideoSyncPrototype.Phone.Apps.Games.Pairs;
using VideoSyncPrototype.Phone.Apps.Games.Reversi;
using VideoSyncPrototype.Phone.Apps.Games.Simon;
using VideoSyncPrototype.Phone.Apps.Games.Snake;
using VideoSyncPrototype.Phone.Apps.Games.Solitaire;
using VideoSyncPrototype.Phone.Apps.Games.Sweeper;
using VideoSyncPrototype.Phone.Apps.Games.Tetris;
using VideoSyncPrototype.Phone.Apps.Games.Twenty48;
using VideoSyncPrototype.Phone.Apps.Games.WaterSort;
using VideoSyncPrototype.Phone.Apps.Games.Whack;
...
namespace VideoSyncPrototype.Phone.Apps.Games;
