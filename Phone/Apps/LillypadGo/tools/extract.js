...
const SPECIAL_EFFECTS = {
  ...
  belch: ['RequiresBerry', 0, 1],
  ancientpower: ['RaiseAllStats', 10, 1],
  ...
  bind: ['TrapDamage', 0, 1],
  bugbite: ['ConsumeTargetItem', 0, 1],
  block: ['TrapTarget', 0, 1],
  brickbreak: ['BreakScreens', 0, 1],
  chargebeam: ['RaiseSpAtk', 70, 1],
  closecombat: ['LowerUserAtkDef', 0, 1],
  covet: ['StealItem', 0, 1],
  ...
  copycat: ['Copycat', 0, 1],
  counter: ['Counter', 0, 1],
  mirrorcoat: ['MirrorCoat', 0, 1],
  metalburst: ['MetalBurst', 0, 1],
  endeavor: ['Endeavor', 0, 1],
  finalgambit: ['FinalGambit', 0, 1],
  firespin: ['TrapDamage', 0, 1],
  fling: ['FlingItem', 0, 1],
  futuresight: ['FutureSight', 0, 1],
  flamecharge: ['RaiseSpd', 100, 1],
  painsplit: ['PainSplit', 0, 1],
  rest: ['Rest', 0, 1],
  trickroom: ['TrickRoom', 0, 1],
  outrage: ['LockInMove', 0, 1],
  thrash: ['LockInMove', 0, 1],
  petaldance: ['LockInMove', 0, 1],
  ragingfury: ['LockInMove', 0, 1],
  curse: ['RaiseAtk', 0, 1],
  destinybond: ['DestinyBond', 0, 1],
  detect: ['ProtectUser', 0, 1],
  disable: ['Disable', 0, 1],
  dracometeor: ['LowerUserSpAtk', 0, 2],
  ...
  metronome: ['Metronome', 0, 1],
  metalclaw: ['RaiseAtk', 10, 1],
  meteormash: ['RaiseAtk', 20, 1],
  mimic: ['RaiseAccuracy', 0, 1],
  miracleeye: ['LowerTargetEvasion', 0, 1],
  mirrormove: ['MirrorMove', 0, 1],
  mist: ['MistSide', 0, 1],
  mistyterrain: ['SetMistyTerrain', 0, 1],
  ominouswind: ['RaiseAllStats', 10, 1],
  overheat: ['LowerUserSpAtk', 0, 2],
  payday: ['PayDay', 0, 1],
  mudsport: ['RaiseSpDef', 0, 1],
  perishsong: ['PerishSong', 0, 1],
  powerswap: ['RaiseSpAtk', 0, 1],
  poltergeist: ['RequiresItem', 0, 1],
  protect: ['ProtectUser', 0, 1],
  pluck: ['ConsumeTargetItem', 0, 1],
  psystrike: ['None', 0, 1],
  psychicfangs: ['BreakScreens', 0, 1],
  psychicnoise: ['HealBlock', 0, 1],
  ...
  safeguard: ['SafeguardSide', 0, 1],
  sandstorm: ['SetSandstorm', 0, 1],
  sandtomb: ['TrapDamage', 0, 1],
  sleeptalk: ['SleepTalk', 0, 1],
  skillswap: ['SkillSwap', 0, 1],
  silverwind: ['RaiseAllStats', 10, 1],
  snowscape: ['SetSnow', 0, 1],
  superpower: ['LowerUserAtkDef', 0, 1],
  soak: ['LowerTargetSpDef', 0, 1],
  spikes: ['Spikes', 0, 1],
  spite: ['LowerTargetSpAtk', 0, 1],
  splash: ['NoOp', 0, 1],
  spotlight: ['RaiseDef', 0, 1],
  stealthrock: ['StealthRock', 0, 1],
  stockpile: ['Stockpile', 0, 1],
  spitup: ['SpitUp', 0, 1],
  ...
  switcheroo: ['SwitchItems', 0, 1],
  tailwind: ['TailwindSide', 0, 1],
  taunt: ['Taunt', 0, 1],
  telekinesis: ['LowerTargetEvasion', 0, 1],
  teleport: ['ForceSwitch', 0, 1],
  toxicspikes: ['ToxicSpikes', 0, 1],
  trailblaze: ['RaiseSpd', 100, 1],
  triattack: ['TriStatus', 20, 1],
  trick: ['SwitchItems', 0, 1],
  watersport: ['WaterSport', 0, 1],
  whirlpool: ['TrapDamage', 0, 1],
  whirlwind: ['ForceSwitch', 0, 1],
  wideguard: ['ProtectUser', 0, 1],
  wonderroom: ['Haze', 0, 1],
  worryseed: ['WorrySeed', 0, 1],
  workup: ['WorkUp', 0, 1],
  wrap: ['TrapDamage', 0, 1],
  yawn: ['Yawn', 0, 1],
};
