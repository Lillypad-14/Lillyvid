...
internal static class ArrZones
{
    ...
    public static readonly IReadOnlyList<ZoneDefinition> All = new[]
    {
        ...
        new ZoneDefinition(135, "La Noscea", 0, "Lower La Noscea", Biome.Coast, 3, 5, 12, "goldeen",
            new SpawnEntry("slowpoke", 34, 5, 12), new SpawnEntry("squirtle", 28, 5, 12), new SpawnEntry("pikachu", 22, 5, 12), new SpawnEntry("psyduck", 16, 5, 12), new SpawnEntry("goldeen", 22, 5, 12), new SpawnEntry("ekans", 10, 5, 12), new SpawnEntry("nidoranf", 10, 5, 12), new SpawnEntry("nidoranm", 10, 5, 12), new SpawnEntry("clefairy", 10, 5, 12), new SpawnEntry("zubat", 10, 5, 12), new SpawnEntry("mankey", 10, 5, 12), new SpawnEntry("poliwag", 10, 5, 12), new SpawnEntry("abra", 10, 5, 12), new SpawnEntry("machop", 10, 5, 12), new SpawnEntry("tentacool", 10, 5, 12), new SpawnEntry("magnemite", 10, 5, 12), new SpawnEntry("doduo", 10, 5, 12), new SpawnEntry("seel", 10, 5, 12), new SpawnEntry("grimer", 10, 5, 12), new SpawnEntry("shellder", 10, 5, 12), new SpawnEntry("gastly", 10, 5, 12), new SpawnEntry("krabby", 10, 5, 12), new SpawnEntry("voltorb", 10, 5, 12), new SpawnEntry("horsea", 10, 5, 12), new SpawnEntry("staryu", 10, 5, 12)),
        ...
        new ZoneDefinition(152, "The Black Shroud", 1, "East Shroud", Biome.Forest, 5, 8, 16, "exeggcute",
            new SpawnEntry("pidgeotto", 34, 8, 16), new SpawnEntry("farfetchd", 28, 8, 16), new SpawnEntry("lickitung", 22, 8, 16), new SpawnEntry("weepinbell", 16, 8, 16), new SpawnEntry("exeggcute", 22, 8, 16), new SpawnEntry("bulbasaur", 10, 8, 16), new SpawnEntry("kakuna", 10, 8, 16), new SpawnEntry("raticate", 10, 8, 16), new SpawnEntry("jigglypuff", 10, 8, 16), new SpawnEntry("oddish", 10, 8, 16), new SpawnEntry("paras", 10, 8, 16), new SpawnEntry("parasect", 10, 8, 16), new SpawnEntry("venonat", 10, 8, 16), new SpawnEntry("meowth", 10, 8, 16), new SpawnEntry("bellsprout", 10, 8, 16), new SpawnEntry("eevee", 10, 8, 16)),
        ...
        new ZoneDefinition(153, "The Black Shroud", 1, "South Shroud", Biome.Wetland, 8, 18, 28, "arbok",
            new SpawnEntry("seadra", 34, 18, 28), new SpawnEntry("ivysaur", 28, 18, 28), new SpawnEntry("wartortle", 22, 18, 28), new SpawnEntry("haunter", 16, 18, 28), new SpawnEntry("arbok", 22, 18, 28), new SpawnEntry("beedrill", 10, 18, 28), new SpawnEntry("nidorina", 10, 18, 28), new SpawnEntry("nidorino", 10, 18, 28), new SpawnEntry("gloom", 10, 18, 28), new SpawnEntry("koffing", 10, 18, 28)),
        new ZoneDefinition(139, "La Noscea", 0, "Upper La Noscea", Biome.Wetland, 9, 20, 30, "golbat",
            new SpawnEntry("arbok", 34, 20, 30), new SpawnEntry("venomoth", 28, 20, 30), new SpawnEntry("seaking", 22, 20, 30), new SpawnEntry("seadra", 16, 20, 30), new SpawnEntry("golbat", 22, 20, 30), new SpawnEntry("primeape", 10, 20, 30), new SpawnEntry("kingler", 10, 20, 30), new SpawnEntry("hitmonlee", 10, 20, 30), new SpawnEntry("hitmonchan", 10, 20, 30), new SpawnEntry("weezing", 10, 20, 30)),
        new ZoneDefinition(154, "The Black Shroud", 1, "North Shroud", Biome.Forest, 10, 24, 34, "vileplume",
            new SpawnEntry("dodrio", 34, 24, 34), new SpawnEntry("pidgeot", 28, 24, 34), new SpawnEntry("venomoth", 22, 24, 34), new SpawnEntry("chansey", 16, 24, 34), new SpawnEntry("vileplume", 22, 24, 34), new SpawnEntry("fearow", 10, 24, 34), new SpawnEntry("wigglytuff", 10, 24, 34), new SpawnEntry("persian", 10, 24, 34), new SpawnEntry("victreebel", 10, 24, 34), new SpawnEntry("tangela", 10, 24, 34), new SpawnEntry("kangaskhan", 10, 24, 34), new SpawnEntry("mrmime", 10, 24, 34), new SpawnEntry("pinsir", 10, 24, 34), new SpawnEntry("tauros", 10, 24, 34)),
        new ZoneDefinition(146, "Thanalan", 2, "Southern Thanalan", Biome.Desert, 11, 25, 38, "rhydon",
            new SpawnEntry("golem", 34, 25, 38), new SpawnEntry("magmar", 28, 25, 38), new SpawnEntry("omastar", 22, 25, 38), new SpawnEntry("kabutops", 16, 25, 38), new SpawnEntry("rhydon", 22, 25, 38), new SpawnEntry("sandslash", 10, 25, 38), new SpawnEntry("nidoqueen", 10, 25, 38), new SpawnEntry("nidoking", 10, 25, 38), new SpawnEntry("clefable", 10, 25, 38), new SpawnEntry("muk", 10, 25, 38), new SpawnEntry("hypno", 10, 25, 38)),
        new ZoneDefinition(137, "La Noscea", 0, "Eastern La Noscea", Biome.Coast, 12, 28, 38, "cloyster",
            new SpawnEntry("tentacruel", 34, 28, 38), new SpawnEntry("aerodactyl", 28, 28, 38), new SpawnEntry("poliwrath", 22, 28, 38), new SpawnEntry("starmie", 16, 28, 38), new SpawnEntry("cloyster", 22, 28, 38), new SpawnEntry("raichu", 10, 28, 38), new SpawnEntry("golduck", 10, 28, 38), new SpawnEntry("machamp", 10, 28, 38), new SpawnEntry("slowbro", 10, 28, 38), new SpawnEntry("magneton", 10, 28, 38), new SpawnEntry("electrode", 10, 28, 38), new SpawnEntry("scyther", 10, 28, 38), new SpawnEntry("electabuzz", 10, 28, 38), new SpawnEntry("vaporeon", 10, 28, 38), new SpawnEntry("jolteon", 10, 28, 38)),
        ...
        new ZoneDefinition(147, "Thanalan", 2, "Northern Thanalan", Biome.Volcanic, 14, 38, 46, "ninetales",
            new SpawnEntry("arcanine", 34, 38, 46), new SpawnEntry("charizard", 28, 38, 46), new SpawnEntry("flareon", 22, 38, 46), new SpawnEntry("dragonite", 16, 38, 46), new SpawnEntry("ninetales", 22, 38, 46)),
        new ZoneDefinition(155, "Coerthas", 3, "Coerthas Central Highlands", Biome.Snow, 15, 40, 48, "articuno",
            new SpawnEntry("dewgong", 28, 40, 48), new SpawnEntry("cloyster", 26, 40, 48), new SpawnEntry("jynx", 24, 40, 48), new SpawnEntry("lapras", 18, 40, 48), new SpawnEntry("chansey", 12, 40, 48), new SpawnEntry("snorlax", 10, 40, 48), new SpawnEntry("aerodactyl", 8, 40, 48), new SpawnEntry("dratini", 8, 40, 48), new SpawnEntry("dragonair", 8, 40, 48), new SpawnEntry("porygon", 8, 40, 48), new SpawnEntry("ditto", 8, 40, 48), new SpawnEntry("articuno", 3, 40, 48)),
        new ZoneDefinition(156, "Mor Dhona", 4, "Mor Dhona", Biome.Wetland, 16, 44, 50, "mewtwo",
            new SpawnEntry("gyarados", 28, 44, 50), new SpawnEntry("lapras", 22, 44, 50), new SpawnEntry("blastoise", 18, 44, 50), new SpawnEntry("venusaur", 18, 44, 50), new SpawnEntry("charizard", 18, 44, 50), new SpawnEntry("alakazam", 14, 44, 50), new SpawnEntry("gengar", 14, 44, 50), new SpawnEntry("dragonair", 12, 44, 50), new SpawnEntry("dragonite", 6, 44, 50), new SpawnEntry("rhydon", 10, 44, 50), new SpawnEntry("exeggutor", 10, 44, 50), new SpawnEntry("starmie", 10, 44, 50), new SpawnEntry("zapdos", 3, 44, 50), new SpawnEntry("moltres", 3, 44, 50), new SpawnEntry("mewtwo", 2, 44, 50), new SpawnEntry("mew", 1, 44, 50)),
    };
