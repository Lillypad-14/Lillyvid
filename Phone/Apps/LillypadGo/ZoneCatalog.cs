...
internal static class ArrZones
{
    ...
    public static readonly IReadOnlyList<ZoneDefinition> All = new[]
    {
        ...
        new ZoneDefinition(137, "La Noscea", 0, "Eastern La Noscea", Biome.Coast, 12, 28, 38, "cloyster",
            new SpawnEntry("tentacruel", 34, 28, 38), new SpawnEntry("aerodactyl", 14, 28, 38), new SpawnEntry("poliwrath", 22, 28, 38), new SpawnEntry("starmie", 16, 28, 38), new SpawnEntry("cloyster", 22, 28, 38), new SpawnEntry("raichu", 10, 28, 38), new SpawnEntry("golduck", 10, 28, 38), new SpawnEntry("machamp", 10, 28, 38), new SpawnEntry("slowbro", 10, 28, 38), new SpawnEntry("magneton", 10, 28, 38), new SpawnEntry("electrode", 10, 28, 38), new SpawnEntry("scyther", 10, 28, 38), new SpawnEntry("electabuzz", 10, 28, 38), new SpawnEntry("vaporeon", 10, 28, 38), new SpawnEntry("jolteon", 10, 28, 38)),
        ...
        new ZoneDefinition(147, "Thanalan", 2, "Northern Thanalan", Biome.Volcanic, 14, 38, 46, "dragonite",
            new SpawnEntry("arcanine", 34, 38, 46), new SpawnEntry("charizard", 28, 38, 46), new SpawnEntry("magmar", 22, 38, 46), new SpawnEntry("flareon", 16, 38, 46), new SpawnEntry("rapidash", 16, 38, 46), new SpawnEntry("dragonite", 10, 38, 46)),
